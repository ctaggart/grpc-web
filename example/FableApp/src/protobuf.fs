...
type [<AllowNullLiteral>] IExports =
    abstract Message: MessageStatic with get, set
    abstract ExtensionFieldInfo: ExtensionFieldInfoStatic with get, set
    abstract ExtensionFieldBinaryInfo: ExtensionFieldBinaryInfoStatic with get, set
    abstract Map: MapStatic with get, set
    abstract BinaryReader: BinaryReaderStatic with get, set
    abstract BinaryWriter: BinaryWriterStatic with get, set
    abstract BinaryEncoder: BinaryEncoderStatic with get, set
    abstract BinaryDecoder: BinaryDecoderStatic with get, set
    abstract BinaryIterator: BinaryIteratorStatic with get, set
...
type [<AllowNullLiteral>] Message =
    abstract getJsPbMessageId: unit -> obj
    abstract serializeBinaryExtensions: proto: Message * writer: BinaryWriter * extensions: obj * getExtensionFn: (ExtensionFieldInfo<'T> -> 'T) -> unit
    abstract readBinaryExtension: proto: Message * reader: BinaryReader * extensions: obj * setExtensionFn: (ExtensionFieldInfo<'T> -> 'T -> unit) -> unit
...
type [<AllowNullLiteral>] MessageStatic =
    abstract initialize: msg: Message * data: Message.MessageArray * messageId: obj * suggestedPivot: float * ?repeatedFields: ResizeArray<float> * ?oneofFields: ResizeArray<ResizeArray<float>> option -> unit
    abstract toObjectList: field: ResizeArray<'T> * toObjectFn: (bool -> 'T -> obj) * ?includeInstance: bool -> Array<obj>
    abstract toObjectExtension: msg: Message * obj: obj * extensions: obj * getExtensionFn: (ExtensionFieldInfo<Message> -> Message) * ?includeInstance: bool -> unit
    ...
    abstract getMapField: msg: Message * fieldNumber: float * noLazyCreate: bool * valueCtor: obj -> Map<obj, obj>
    abstract setField: msg: Message * fieldNumber: float * value: FieldValue -> unit
    abstract addToRepeatedField: msg: Message * fieldNumber: float * value: obj * ?index: float -> unit
    ...
    abstract getWrapperField: msg: Message * ctor: obj * fieldNumber: float * ?required: float -> 'T
    abstract getRepeatedWrapperField: msg: Message * ctor: obj * fieldNumber: float -> ResizeArray<'T>
    abstract setWrapperField: msg: Message * fieldNumber: float * ?value: obj -> unit
    abstract setOneofWrapperField: msg: Message * fieldNumber: float * oneof: ResizeArray<float> * value: obj -> unit
    abstract setRepeatedWrapperField: msg: Message * fieldNumber: float * ?value: ResizeArray<'T> -> unit
    abstract addToRepeatedWrapperField: msg: Message * fieldNumber: float * value: 'T option * ctor: obj * ?index: float -> 'T
    abstract toMap: field: ResizeArray<obj> * mapKeyGetterFn: (obj -> string) * ?toObjectFn: Message.StaticToObject * ?includeInstance: bool -> unit
    abstract difference: m1: 'T * m2: 'T -> 'T
    abstract equals: m1: Message * m2: Message -> bool
    abstract compareExtensions: extension1: obj * extension2: obj -> bool
    abstract compareFields: field1: obj * field2: obj -> bool
...
type [<AllowNullLiteral>] ExtensionFieldInfoStatic =
    [<Emit "new $0($1...)">] abstract Create: fieldIndex: float * fieldName: obj * ctor: obj * toObjectFn: Message.StaticToObject * isRepeated: float -> ExtensionFieldInfo<'T>
...
type [<AllowNullLiteral>] Map<'K, 'V> =
    ...
    abstract forEach: callback: ('V -> 'K -> unit) * ?thisArg: obj -> unit
    abstract set: key: 'K * value: 'V -> Map<'K, 'V>
    abstract get: key: 'K -> obj
    abstract has: key: 'K -> bool

type [<AllowNullLiteral>] MapStatic =
    [<Emit "new $0($1...)">] abstract Create: arr: Array<'K * 'V> * ?valueCtor: obj -> Map<'K, 'V>
    abstract fromObject: entries: Array<'TK * 'TV> * valueCtor: obj * valueFromObject: obj -> Map<'TK, 'TV>
...
type BinaryReadReader =
    (obj -> BinaryReader -> unit)

type BinaryRead =
    (obj -> BinaryReadReader -> unit)

type BinaryWriteCallback =
    (obj -> BinaryWriter -> unit)

type BinaryWrite =
    (float -> obj -> BinaryWriteCallback -> unit)
...
type [<AllowNullLiteral>] BinaryReader =
    ...
    abstract registerReadCallback: callbackName: string * callback: (BinaryReader -> obj) -> unit
    abstract runReadCallback: callbackName: string -> obj
...
type [<AllowNullLiteral>] BinaryWriter =
    ...
    abstract writeGroup: field: float * value: obj * writeCallback: BinaryWriteCallback -> unit
...
module BinaryConstants =
    ...
    type [<AllowNullLiteral>] IExports =
        abstract FieldTypeToWireType: (FieldType -> WireType) with get, set
        abstract INVALID_FIELD_NUMBER: float with get, set
        abstract FLOAT32_EPS: float with get, set
        abstract FLOAT32_MIN: float with get, set
        abstract FLOAT32_MAX: float with get, set
        abstract FLOAT64_EPS: float with get, set
        abstract FLOAT64_MIN: float with get, set
        abstract FLOAT64_MAX: float with get, set
        abstract TWO_TO_20: float with get, set
        abstract TWO_TO_23: float with get, set
        abstract TWO_TO_31: float with get, set
        abstract TWO_TO_32: float with get, set
        abstract TWO_TO_52: float with get, set
        abstract TWO_TO_63: float with get, set
        abstract TWO_TO_64: float with get, set
        abstract ZERO_HASH: string with get, set
...
module arith =
    ...
    type [<AllowNullLiteral>] IExports =
        abstract UInt64: UInt64Static with get, set
        abstract Int64: Int64Static with get, set
